        ...
        <table className="w-full">
          <thead>
            <tr style={{ borderBottom: '1px solid #DADCE0' }}>
              ...
              <th className="text-left px-4 py-3 text-xs font-semibold uppercase tracking-wider" style={{ color: '#5F6368' }}>Katılımcı</th>
              <th className="text-left px-4 py-3 text-xs font-semibold uppercase tracking-wider hidden md:table-cell" style={{ color: '#5F6368' }}>Takım</th>
              ...
              <th className="text-right px-4 py-3 text-xs font-semibold uppercase tracking-wider hidden lg:table-cell" style={{ color: '#5F6368' }}>Sertifika</th>
              <th className="text-right px-4 py-3 text-xs font-semibold uppercase tracking-wider hidden lg:table-cell" style={{ color: '#5F6368' }}>Kurs/Lab</th>
            </tr>
          </thead>
          <tbody>
            {ranked.map((p) => {
